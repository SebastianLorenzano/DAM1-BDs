...
-- TODO: TRIGGER
GO
CREATE OR ALTER TRIGGER TX_SUPPLIERS_DELETE ON SUPPLIERS   
INSTEAD OF DELETE                                      
AS  
BEGIN
    SET XACT_ABORT ON      
...
SELECT *
 ...
 ALTER TABLE CLIENTES_HISTORICO
    ADD fechaMod  DATE NOT NULL


 ALTER TABLE CLIENTES_HISTORICO 
    ADD CONSTRAINT PK_CLIENTES_HISTORICO PRIMARY KEY (codCliente, fechaMod)

GO

CREATE OR ALTER TRIGGER TX_CLIENTES_UPDATE ON CLIENTES
AFTER UPDATE
AS
BEGIN
    SET XACT_ABORT ON  
